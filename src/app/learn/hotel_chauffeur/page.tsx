                        ...
                        <div className="absolute inset-x-0 bottom-0 p-5 md:p-7">
                            <div className={cx(HERO_GLASS, "backdrop-blur-md")}>
                                ...
                                <p className="mt-2 text-sm text-white/90 md:text-[15px] leading-relaxed">
                                    Premium arrivals should feel calm and organized. 6ride supports disciplined
                                    pickups for travelers, executives, and high-standard movement — with clean
                                    presentation, predictable coordination, and professional conduct.
                                </p>

                                <div className="mt-4 flex flex-wrap gap-2">
                                    {["Hotel arrivals", "Executive pickups", "Scheduled trips", "Professional conduct"].map(
                                        (c) => (
                                            <span
                                                key={c}
                        ...
                        <Panel>
                            ...
                            <div className="mt-6 rounded-2xl border border-black/10 bg-neutral-50 p-5">
                                ...
                                <p className="mt-2 text-sm text-neutral-800 leading-relaxed">
                                    Hotels have security, reception flow, and guest expectations. A chaotic pickup
                                    damages the brand and embarrasses customers. 6ride positions this category as
                                    calm, predictable, and professional.
                                </p>
                            </div>
                        </Panel>
